# SPEKT<img width="30" alt="portfolio_view" src="https://github.com/kubevis/kubevis/blob/master/dist/images/src/client/images/kubevis-logo-ecbc06d5.png">
...
* kubectl apply -f [kubevis-deployment.yaml](https://raw.githubusercontent.com/kubevis/kubevis/master/kubevis-deployment.yaml)
...
* kubectl apply -f [fabric8-rbac.yaml](https://raw.githubusercontent.com/kubevis/kubevis/master/fabric8-rbac.yaml).
...
This project is licensed under the MIT License - see the [LICENSE.md](https://github.com/kubevis/kubevis/blob/master/LICENSE) file for details
